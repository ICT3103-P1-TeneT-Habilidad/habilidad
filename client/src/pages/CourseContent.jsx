...
const CourseContent = () => {
    ...
    const sortedMaterials = sortCourseMaterials(courseData.courseMaterial)

    const [selectedMaterial, setSelectedMaterial] = useState(sortedMaterials[0])
                    ...
                    <div className="flex flex-col w-4/5 px-3">
                        <div className="flex w-full">
                            <label className="block uppercase tracking-wide text-gray-700 text-2xl font-bold mb-2">
                                {courseData.courseName} - Lesson {selectedMaterial.order}: {selectedMaterial.title}
                            </label>
                        </div>
                        <div className="flex w-full">
                            <iframe
